...
if(SINGLE_PRECISION)
    ...
    if(ENABLE_SIMD_512)
        set(ext_conf_flags_fft --enable-threads --enable-float --enable-avx512 --prefix=${FFTW_PATH})
    elseif(ENABLE_SIMD_256)
        set(ext_conf_flags_fft --enable-threads --enable-float --enable-avx --enable-avx2 --prefix=${FFTW_PATH})
    ...
    if(ENABLE_SIMD_512)
        set(ext_conf_flags_fft --enable-threads --enable-avx512 --prefix=${FFTW_PATH})
    elseif(ENABLE_SIMD_256)
        set(ext_conf_flags_fft --enable-threads --enable-avx --enable-avx2 --prefix=${FFTW_PATH})
    else(ENABLE_SIMD_512)
