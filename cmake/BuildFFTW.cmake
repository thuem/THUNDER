set(FFTW_PATH "${PROJECT_SOURCE_DIR}/external/fftw")

if(SINGLE_PRECISION)
    set(libfft "thunder_fftw3f")
...
set(FFTW_LIB "${FFTW_EXTERNAL_PATH}/lib/${libfft}${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(FFTW_INCLUDE "${FFTW_EXTERNAL_PATH}/include")
