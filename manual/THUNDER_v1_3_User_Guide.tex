    ...
    \section{Installation}
        ...
        \subsection{Installing from Source Code}
            ...
            \subsubsection{Preparation Before Configuring Source Code}
                ...
                Firstly, make sure \textsf{fftw3}, \textsf{gsl} and \textsf{cmake} have been installed and correctly placed in environment. Secondly, set up system variable \textsf{CC} and \textsf{CXX} to be C compiler and C++ compiler with MPI wrapper, such as \textsf{mpicc} and \textsf{mpicxx}, respectively. Thus, \textsf{cmake} can correctly set up the C/C++ compiler for compiling THUNDER source code.
        
            \subsubsection{Configure Using \textsf{cmake}}
            
                In THUNDER source code directory, assuming it is \textsf{THUNDER\_dir}, please type in the following commands for configuring source code.
...
make -j20
                ...
                After compiling, the compiled binaries can all placed in directory \textsf{THUNDER\_dir/build/app}, which are listed below.
                \begin{itemize}
                    \item \textsf{thunder}
