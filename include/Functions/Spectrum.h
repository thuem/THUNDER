...
/** @brief This function returns the Nyquist resolution limit in Angstrom(-1).
 *  @param pixelSize pixel size in Angstrom
 */
double nyquist(const double pixelSize);

/** @brief This function converts resolution from pixel to Angstrom(-1).
...
/** @brief This function converts resolution from Angstrom(-1) to pixel.
...
/** @brief This function converts a vector of resolution from pixel to
 *         Angstorm(-1).
...
/** @brief This function converts a vector of resolution from Angstrom(-1) to
 *         pixel.
 *  @param res a vector of resolution
 *  @param imgeSize the size of image in pixel
 *  @param pixelSize pixel size in Angstrom
...
/** @brief This function calculates the ring average at a certain resolution
...
/** @brief This function calculates the shell average at a certain resolution
 *         with a given function.
 *  @param resP resolution in pixel
...
/** @brief This function calculates the power spectrum of a certain image within
...
/** @brief This function calculates the power spectrum of a certain volume within
 *         a given spatial frequency.
...
/** @brief This functions calculates the FRC (Fourier Ring Coefficient) between
 *         two images.
...
/** @brief This functions calculates the FSC (Fourier Shell Coefficient) between
 *         two volumes.
