...
/**
 * @brief Transform a volume in real space by interpolation.
 * 
 * For each voxel of volume @f$dst@f$ in real space (restricted to radius @f$r@f$ in Fourier space), transform the real space coordinate into the Fourier space coordinate by transformation matrix @f$mat@f$. Then calculate the real space value by interpolation (the type of interpolation is determined by @f$interp@f$) according to its Fourier space coordinate and thus set transformed volume @f$src@f$.
 */
...
/**
 * @brief Transform a volume in Fourier space by interpolation.
 * 
 * For each voxel of volume @f$dst@f$ in Fourier space (restricted to radius @f$r@f$ in real space), transform the Fourier space coordinate into the real space coordinate by transformation matrix @f$mat@f$. Then calculate the Fourier space value by interpolation (the type of interpolation is determined by @f$interp@f$) according to its real space coordinate and thus set transformed volume @f$src@f$.
 */
 ...
 * 
 * For volume @f$dst@f$ in real space (restricted to radius @f$r@f$ in Fourier space), generate the right transformation matrices according to the symmetry @f$sym@f$ for each symmetry elements. Then set the transformed volume @f$dst@f$ by @f$interp@f$ type interpolation.
 */
 ...
 * 
 * For volume @f$dst@f$ in Fourier space (restricted to radius @f$r@f$ in real space), generate the right transformation matrices according to the symmetry @f$sym@f$ for each symmetry elements. Then set the transformed volume @f$dst@f$ by @f$interp@f$ type interpolation.
 */
