...
/**
 * @brief This function returns the 1D CTF with parameters given in Fourier space. 
 *
 * The input of voltage determines the value of wavelength @f$\lambda@f$. The other variables are substituted into CTF equation computing 1D CTF.
 */
