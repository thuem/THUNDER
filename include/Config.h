...
#define PARTICLE_SYMMETRISE_USING_STAT

#define PARTICLE_BALANCE_WEIGHT
...
#define OPTIMISER_KEEP_ONLY_ONE_CLASS
...
//#define OPTIMISER_SAVE_SOLVENT_FLATTENED_REFERENCE
